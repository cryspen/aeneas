...
theorem Array.index_usize_spec {α : Type u} {n : Usize} (v: Array α n) (i: Usize)
  ...
  simp only [index_usize, Array.getElem?_Usize_eq, List.getElem?_eq_getElem hbound, spec_ok]
...
theorem Array.update_spec {α : Type u} {n : Usize} (v: Array α n) (i: Usize) (x : α)
  ...
  := by
  simp only [update, Array.getElem?_Usize_eq, List.getElem?_eq_getElem hbound]
  apply (spec_ok _).mpr
  rfl
