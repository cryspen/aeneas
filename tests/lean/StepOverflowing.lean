...
/-- [step_overflowing::test_usize_forward_no_overflow]:
    ...
    Visibility: public -/
def test_usize_forward_no_overflow : RustM Unit := do
...
/-- [step_overflowing::test_usize_forward_zero]:
    ...
    Visibility: public -/
def test_usize_forward_zero : RustM Unit := do
...
/-- [step_overflowing::test_usize_forward_overflow_wraps_to_zero]:
    ...
    Visibility: public -/
def test_usize_forward_overflow_wraps_to_zero : RustM Unit := do
  let (v, o) ←
...
/-- [step_overflowing::test_usize_forward_overflow_max_count]:
    ...
    Visibility: public -/
def test_usize_forward_overflow_max_count : RustM Unit := do
  let (v, o) ←
...
/-- [step_overflowing::test_usize_backward_no_overflow]:
    ...
    Visibility: public -/
def test_usize_backward_no_overflow : RustM Unit := do
  let (v, o) ←
...
/-- [step_overflowing::test_usize_backward_overflow]:
    ...
    Visibility: public -/
def test_usize_backward_overflow : RustM Unit := do
...
/-- [step_overflowing::test_u8_forward_no_overflow]:
    ...
    Visibility: public -/
def test_u8_forward_no_overflow : RustM Unit := do
...
/-- [step_overflowing::test_u8_forward_overflow_count_fits]:
    ...
    Visibility: public -/
def test_u8_forward_overflow_count_fits : RustM Unit := do
...
/-- [step_overflowing::test_u8_forward_count_too_large]:
    ...
    Visibility: public -/
def test_u8_forward_count_too_large : RustM Unit := do
...
/-- [step_overflowing::test_u8_backward_no_overflow]:
    ...
    Visibility: public -/
def test_u8_backward_no_overflow : RustM Unit := do
...
/-- [step_overflowing::test_u8_backward_overflow_count_fits]:
    ...
    Visibility: public -/
def test_u8_backward_overflow_count_fits : RustM Unit := do
...
/-- [step_overflowing::test_u8_backward_count_too_large]:
    ...
    Visibility: public -/
def test_u8_backward_count_too_large : RustM Unit := do
...
/-- [step_overflowing::test_i32_forward_negative_no_overflow]:
    ...
    Visibility: public -/
def test_i32_forward_negative_no_overflow : RustM Unit := do
...
/-- [step_overflowing::test_i32_forward_overflow]:
    ...
    Visibility: public -/
def test_i32_forward_overflow : RustM Unit := do
  let (v, o) ←
...
/-- [step_overflowing::test_i32_forward_count_max]:
    ...
    Visibility: public -/
def test_i32_forward_count_max : RustM Unit := do
  let (v, o) ←
...
/-- [step_overflowing::test_i32_backward_negative_no_overflow]:
    ...
    Visibility: public -/
def test_i32_backward_negative_no_overflow : RustM Unit := do
...
/-- [step_overflowing::test_i32_backward_overflow]:
    ...
    Visibility: public -/
def test_i32_backward_overflow : RustM Unit := do
  let (v, o) ←
...
/-- [step_overflowing::test_i32_backward_count_max]:
    ...
    Visibility: public -/
def test_i32_backward_count_max : RustM Unit := do
  let (v, o) ←
...
/-- [step_overflowing::test_i8_forward_overflow]:
    ...
    Visibility: public -/
def test_i8_forward_overflow : RustM Unit := do
...
/-- [step_overflowing::test_i8_backward_overflow]:
    ...
    Visibility: public -/
def test_i8_backward_overflow : RustM Unit := do
...
/-- [step_overflowing::test_u128_forward_no_overflow]:
    ...
    Visibility: public -/
def test_u128_forward_no_overflow : RustM Unit := do
  let (v, o) ←
...
/-- [step_overflowing::test_u128_forward_overflow]:
    ...
    Visibility: public -/
def test_u128_forward_overflow : RustM Unit := do
  let (v, o) ←
...
/-- [step_overflowing::test_i128_backward_overflow]:
    ...
    Visibility: public -/
def test_i128_backward_overflow : RustM Unit := do
  let (v, o) ←
