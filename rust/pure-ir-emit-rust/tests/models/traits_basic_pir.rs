...
pub struct traits_basic_Tag_0;

pub fn traits_basic_Numeric_value_1<Self_>(p0: impl core::marker::Sized) -> Result<u32> where Self_: 'static {
    unimplemented!("opaque body")
}

pub fn traits_basic_use_numeric_0(t: traits_basic_Tag_0) -> Result<u32> {
    (impl_traits_basic_value_2(t))
}

pub fn impl_traits_basic_value_2(self_: traits_basic_Tag_0) -> Result<u32> {
    Ok(42u32)
}
