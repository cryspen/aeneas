...
pub fn loops_nested_ntt_layer_5(a: [u16; 256usize], k: usize, len: usize) -> Result<[u16; 256usize]> {
    (loops_nested_ntt_layer_5_loop0(a, k, len, 0usize))
}

pub fn loops_nested_generate_matrix_11(key: loops_nested_Key_0, state_base: [u8; 8usize], state_work: [u8; 8usize]) -> Result<(loops_nested_Key_0, [u8; 8usize], [u8; 8usize])> {
    let coordinates_0: [u8; 2usize] = unimplemented!("placeholder");
    let state_base_1: [u8; 8usize] = (loops_nested_shake_init_6(state_base))?;
    let v2: Vec<u8> = Ok(unimplemented!("FBuiltin call"))?;
    let state_base_3: [u8; 8usize] = (loops_nested_shake_append_7(state_base_1, v2))?;
    let (key_4, state_work_5): (loops_nested_Key_0, [u8; 8usize]) = (loops_nested_generate_matrix_11_loop0(key, state_base_3, state_work, coordinates_0, 0u8))?;
    Ok((key_4, state_base_3, state_work_5))
}

pub fn loops_nested_mul_add_as_plus_e_12<const N: usize>(out: Vec<u16>, s: Vec<u16>, seed_a: [u8; 16usize]) -> Result<Vec<u16>> {
    ...
    let _: () = (loops_nested_mul_add_as_plus_e_12_loop0(iter_4, a_row_temp_2))?;
    Ok(out)
}

pub fn loops_nested_update_array_2() -> Result<()> {
    let out_0: [u8; 4usize] = unimplemented!("placeholder");
    (loops_nested_update_array_2_loop0(out_0, 0usize))
}

pub fn loops_nested_sum_1(m: u32, n: u32) -> Result<u32> {
    (loops_nested_sum_1_loop0(m, n, 0u32, 0u32))
}

pub fn loops_nested_iter_0(m: u32, n: u32) -> Result<()> {
    (loops_nested_iter_0_loop0(m, n, 0u32))
}

pub fn loops_nested_generate_matrix_inner_10(key: loops_nested_Key_0, state: [u8; 8usize]) -> Result<(loops_nested_Key_0, [u8; 8usize])> {
    (loops_nested_generate_matrix_inner_10_loop0(key, state, 0usize))
}

pub fn loops_nested_mod_sub_4(a: u32, b: u32) -> Result<u32> {
...
pub fn loops_nested_mod_add_3(a: u32, b: u32) -> Result<u32> {
    let v0: u32 = (a.checked_add(b).ok_or(()))?;
    (v0.checked_rem(3329u32).ok_or(()))
}

pub fn impl_loops_nested_atranspose_mut_15(self_: loops_nested_Key_0) -> Result<([u16; 32usize], Box<dyn FnOnce([u16; 32usize]) -> loops_nested_Key_0>)> {
    let back_0: Box<dyn FnOnce([u16; 32usize]) -> loops_nested_Key_0> = (Box::new(move |v1: [u16; 32usize]| -> loops_nested_Key_0 { loops_nested_Key_0 { seed: self_.seed, atranspose: v1 } }) as Box<dyn FnOnce([u16; 32usize]) -> loops_nested_Key_0>);
    Ok((self_.atranspose, back_0))
}

pub fn loops_nested_shake_init_6(_state: [u8; 8usize]) -> Result<[u8; 8usize]> {
    Ok(_state)
}

pub fn loops_nested_shake_append_7(_state: [u8; 8usize], _data: Vec<u8>) -> Result<[u8; 8usize]> {
    Ok(_state)
}

pub fn loops_nested_shake_state_copy_8(_src: [u8; 8usize], _dst: [u8; 8usize]) -> Result<[u8; 8usize]> {
    Ok(_dst)
}

pub fn loops_nested_sample_ntt_9(_state: [u8; 8usize], _dst: u16) -> Result<([u8; 8usize], u16)> {
    Ok((_state, _dst))
}

pub fn loops_nested_FACTORS_13() -> [u16; 32usize] {
...
pub fn loops_nested_ntt_layer_5_loop0(a: [u16; 256usize], k: usize, len: usize, start: usize) -> Result<[u16; 256usize]> {
    panic!("LoopOp placeholder")
}

pub fn loops_nested_ntt_layer_5_loop1(a: [u16; 256usize], len: usize, start: usize, factor: u32, j: usize) -> Result<[u16; 256usize]> {
    panic!("LoopOp placeholder")
}

pub fn loops_nested_generate_matrix_11_loop0(key: loops_nested_Key_0, state_base: [u8; 8usize], state_work: [u8; 8usize], coordinates: [u8; 2usize], i: u8) -> Result<(loops_nested_Key_0, [u8; 8usize])> {
    panic!("LoopOp placeholder")
}

pub fn loops_nested_generate_matrix_11_loop1(key: loops_nested_Key_0, state_base: [u8; 8usize], state_work: [u8; 8usize], coordinates: [u8; 2usize], i: u8, j: u8) -> Result<(loops_nested_Key_0, [u8; 8usize], [u8; 2usize])> {
    panic!("LoopOp placeholder")
}

pub fn loops_nested_mul_add_as_plus_e_12_loop0(iter: core_iter_adapters_step_by_StepBy_4<core_ops_range_Range_5<usize>>, a_row_temp: alloc_vec_Vec_2<u8>) -> Result<()> {
    panic!("LoopOp placeholder")
}

pub fn loops_nested_mul_add_as_plus_e_12_loop1(iter: core_ops_range_Range_5<usize>, a_row_temp: alloc_vec_Vec_2<u8>, j: usize) -> Result<alloc_vec_Vec_2<u8>> {
    panic!("LoopOp placeholder")
}

pub fn loops_nested_update_array_2_loop0(out: [u8; 4usize], i: usize) -> Result<()> {
    panic!("LoopOp placeholder")
}

pub fn loops_nested_update_array_2_loop1(out: [u8; 4usize], j: usize) -> Result<[u8; 4usize]> {
    panic!("LoopOp placeholder")
}

pub fn loops_nested_sum_1_loop0(m: u32, n: u32, s: u32, i: u32) -> Result<u32> {
    panic!("LoopOp placeholder")
}

pub fn loops_nested_sum_1_loop1(n: u32, s: u32, j: u32) -> Result<u32> {
    panic!("LoopOp placeholder")
}

pub fn loops_nested_iter_0_loop0(m: u32, n: u32, i: u32) -> Result<()> {
    panic!("LoopOp placeholder")
}

pub fn loops_nested_iter_0_loop1(n: u32, j: u32) -> Result<()> {
    panic!("LoopOp placeholder")
}

pub fn loops_nested_generate_matrix_inner_10_loop0(key: loops_nested_Key_0, state: [u8; 8usize], j: usize) -> Result<(loops_nested_Key_0, [u8; 8usize])> {
    panic!("LoopOp placeholder")
}
