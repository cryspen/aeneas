...
// TODO: opaque type core_fmt_Arguments_0 — emitting marker struct.
pub struct core_fmt_Arguments_0;

pub fn impl_core_fmt_from_str_1(p0: impl core::marker::Sized) -> Result<core_fmt_Arguments_0> {
    unimplemented!("opaque body")
}

pub fn std_io_stdio__print_2(p0: impl core::marker::Sized) -> Result<()> {
    unimplemented!("opaque body")
}

pub fn print_call_println_0() -> Result<()> {
    let v0: core_fmt_Arguments_0 = (impl_core_fmt_from_str_1("Hello World!
"))?;
    (std_io_stdio__print_2(v0))
}
