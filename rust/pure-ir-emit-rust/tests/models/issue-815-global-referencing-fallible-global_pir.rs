...
pub fn issue_815_global_referencing_fallible_global_INNER_0() -> Result<u32> {
    (1u32.checked_add(1u32).ok_or(()))
}

pub fn issue_815_global_referencing_fallible_global_OUTER_1() -> Result<u32> {
