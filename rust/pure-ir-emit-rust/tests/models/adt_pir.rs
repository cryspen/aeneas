...
pub struct adt_Struct_0 {
    pub len: usize,
}

pub struct adt_BigStructName_1;

pub struct adt_BigStruct_2(adt_BigStructName_1, adt_BigStructName_1, adt_BigStructName_1, adt_BigStructName_1, adt_BigStructName_1, adt_BigStructName_1);

pub fn impl_adt_f_1() -> Result<()> {
    Ok(())
}

pub fn impl_adt_len_0(self_: adt_Struct_0) -> Result<usize> {
    Ok(self_.len)
}
