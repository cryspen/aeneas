...
pub enum enums_basic_Sign_0 {
    Pos,
    Neg,
    Zero,
}

pub fn enums_basic_flip_0(s: enums_basic_Sign_0) -> Result<enums_basic_Sign_0> {
    match s {
    enums_basic_Sign_0::Pos => Ok(enums_basic_Sign_0::Neg),
    enums_basic_Sign_0::Neg => Ok(enums_basic_Sign_0::Pos),
    enums_basic_Sign_0::Zero => Ok(enums_basic_Sign_0::Zero),
}
}
