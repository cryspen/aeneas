...
pub fn static__read_0<S>(p0: S, i: usize) -> Result<u16> where S: 'static {
    let v0: Vec<u16> = (Err::<Vec<u16>, ()>(()))?;
    unimplemented!("FBuiltin call")
}

pub fn static__use_static_PREFIX_3() -> [u8; 1usize] {
    [0u8]
}

pub fn static__use_static_1() -> Result<()> {
    Ok(())
}
