...
pub struct reborrows_Pair_0 {
    pub fst: u32,
    pub snd: u32,
}

pub fn reborrows_set_idx_1(xs: [u32; 4usize], i: usize, v: u32) -> Result<[u32; 4usize]> {
    Err::<_, ()>(())
}

pub fn reborrows_reborrow_chain_2(x: u32) -> Result<u32> {
    Ok(7u32)
}

pub fn reborrows_set_fst_0(p: reborrows_Pair_0, v: u32) -> Result<reborrows_Pair_0> {
    Ok(reborrows_Pair_0 { fst: v, snd: p.snd })
}
