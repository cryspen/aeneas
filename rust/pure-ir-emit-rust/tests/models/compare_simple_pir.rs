...
pub fn impl_core_num_wrapping_add_3(p0: u32, p1: u32) -> u32 {
    // route: core_models::num::*::wrapping_add → rust_primitives::arithmetic::wrapping_add_<t>
    u32::wrapping_add(p0, p1)
}

pub fn compare_simple_add_u32_2(a: u32, b: u32) -> Result<u32> {
    Ok((impl_core_num_wrapping_add_3(a, b)))
}

pub fn compare_simple_incr_val_1(x: u32) -> Result<u32> {
    (x.checked_add(1u32).ok_or(()))
}

pub fn compare_simple_id_u32_0(x: u32) -> Result<u32> {
    Ok(x)
}
