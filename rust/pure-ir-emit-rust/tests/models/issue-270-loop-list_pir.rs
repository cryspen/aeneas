...
pub enum issue_270_loop_list_List_0<T> {
    Cons(T, Box<issue_270_loop_list_List_0<T>>),
    Nil,
}

pub fn issue_270_loop_list_foo_0(v: issue_270_loop_list_List_0<issue_270_loop_list_List_0<u8>>) -> Result<()> {
    match v {
    issue_270_loop_list_List_0::Cons(_, __rec_0) => (issue_270_loop_list_foo_0_loop0((*__rec_0))),
    issue_270_loop_list_List_0::Nil => Ok(()),
}
}

pub fn issue_270_loop_list_foo_0_loop0(t: issue_270_loop_list_List_0<issue_270_loop_list_List_0<u8>>) -> Result<()> {
    match t {
    issue_270_loop_list_List_0::Cons(_, __rec_0) => (issue_270_loop_list_foo_0_loop0((*__rec_0))),
    issue_270_loop_list_List_0::Nil => Ok(()),
}
